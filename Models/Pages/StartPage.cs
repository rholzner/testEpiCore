...
namespace Models.Pages
{
  ...
  public class StartPage : SitePageData
  {
    ...
    [Display(GroupName = SiteGlobal.GroupNames.SiteSettings, Order = 300)]
    public virtual LinkItemCollection ProductPageLinks { get; set; }

    [Display(GroupName = SiteGlobal.GroupNames.SiteSettings, Order = 350)]
    public virtual LinkItemCollection CompanyInformationPageLinks { get; set; }

    [Display(GroupName = SiteGlobal.GroupNames.SiteSettings, Order = 400)]
    public virtual LinkItemCollection NewsPageLinks { get; set; }

    [Display(GroupName = SiteGlobal.GroupNames.SiteSettings, Order = 450)]
    public virtual LinkItemCollection CustomerZonePageLinks { get; set; }

    [Display(GroupName = SiteGlobal.GroupNames.SiteSettings)]
